 ...
 */
class assessmentsoverviewbytype extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'charttype' => new external_value(PARAM_INT, 'The selected type'),
        ]);
    }
    ...
    public static function execute(string $guid, int $charttype): array {
        ...
        $assessmentsoverviewbytype = \block_newgu_spdetails\course::assessmentsoverviewbytype($params['guid'], $params['charttype']);

        $data['result'] = json_encode($assessmentsoverviewbytype);
