...
$string['back_to'] = 'Clear filter';
$string['beta_notification'] = 'You can continue to view and access all your courses via the \'My courses\' page. Any questions about visibility of courses or assessments on MyGrades, please contact your course lecturer and/or administrator.';
...
$string['error_text'] = 'MyGrades cannot continue due to a configuration error with this course, and cannot be displayed.';
$string['error_text_guidance'] = 'Please copy the above error message and send it to your course convenor for attention.';
...
$string['header_assessmentsdue'] = 'Filter - Assessments due in the next: {$a}';
$string['header_assessmentsummary'] = 'Filter - Assessments Overview: {$a}';
...
$string['status_class_nosubmissionrequired'] = 'status-nosubmissionrequired';
...
$string['status_nosubmissionrequired'] = 'nosubmissionrequired';
...
$string['status_text_notyetgraded'] = 'Not yet graded';
